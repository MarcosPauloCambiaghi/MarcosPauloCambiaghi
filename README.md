...
💻 Estudando **Java**, **Kotlin** e **Android Studio**  
🚀 Criando meus primeiros aplicativos e explorando o mundo mobile!  
📍 Focado em construir **projetos úteis e práticos para o dia a dia**

Sou apaixonado por tecnologia e desenvolvimento web.  
Antes de entrar no mundo mobile, estudei e pratiquei **HTML, CSS, JavaScript, Node.js, Bootstrap, Linux e PHP** — o que me deu uma base sólida como desenvolvedor **full-stack iniciante**.


## 💼 Sobre mim

- 🎓 Explorando o mundo do **desenvolvimento full-stack** com ambiente **Linux**.  
- 🚀 Criando **projetos pessoais e aplicativos Android** para praticar o que aprendo.  
- 🌍 Buscando colaborar em projetos **open source** e fortalecer meu portfólio.  
- 🧩 Sempre estudando novas tecnologias e aprimorando minhas habilidades.


## 🛠️ Tecnologias & Ferramentas que já estudei
...
## 🧠 Atualmente, estou finalizando meus estudos em **Android (Java e Kotlin)** e meu próximo objetivo 
é **retomar que tive um contato e me aprimorar** meus conhecimentos nessas tecnologias.
...
- 🔹 **[Curriculo_online](https://github.com/MarcosPauloCambiaghi/Curriculo_online)** — Currículo web feito com HTML e CSS.  
- 🔹 **[PrimeiroBootstrap](https://github.com/MarcosPauloCambiaghi/PrimeiroBootstrap)** — Site responsivo feito com Bootstrap.  
- 🔹 **[Toti_Produtos](https://github.com/MarcosPauloCambiaghi/Toti_Produtos)** — Catálogo de produtos simples em HTML.  
- 🔹 **[AulaCalculadoraIMC](https://github.com/MarcosPauloCambiaghi/AulaCalculadoraIMC)** — App Android (Kotlin) para cálculo do IMC.
